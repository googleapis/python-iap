...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (IdentityAwareProxyAdminServiceAsyncClient, transports.IdentityAwareProxyAdminServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_list_tunnel_dest_groups_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, service.TunnelDestGroup)
                   for i in results)
...
def test_create_tunnel_dest_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_tunnel_dest_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_tunnel_dest_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_tunnel_dest_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.TunnelDestGroup(
            name='name_value',
...
def test_delete_tunnel_dest_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_tunnel_dest_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_tunnel_dest_group(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_tunnel_dest_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.TunnelDestGroup(
            name='name_value',
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_set_iam_policy") as post, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "pre_set_iam_policy") as pre:
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_get_iam_policy") as post, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_test_iam_permissions") as post, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_iap_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_get_iap_settings") as post, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "pre_get_iap_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_iap_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_update_iap_settings") as post, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "pre_update_iap_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_tunnel_dest_groups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_list_tunnel_dest_groups") as post, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "pre_list_tunnel_dest_groups") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_tunnel_dest_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_create_tunnel_dest_group") as post, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "pre_create_tunnel_dest_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_tunnel_dest_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_get_tunnel_dest_group") as post, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "pre_get_tunnel_dest_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_tunnel_dest_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "pre_delete_tunnel_dest_group") as pre:
        pre.assert_not_called()
...
def test_update_tunnel_dest_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "post_update_tunnel_dest_group") as post, \
         mock.patch.object(transports.IdentityAwareProxyAdminServiceRestInterceptor, "pre_update_tunnel_dest_group") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_transport_kind(transport_name):
    transport = IdentityAwareProxyAdminServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
